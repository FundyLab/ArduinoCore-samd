# FundyLab plain Bootloader for Arduino

## Modified by FundyLab, 2025.
This Bootloader is for ATSAMD21G18A with no LED control for FundyLab plain board
- Modified files: board_definitions.h, board_driver_led.h, Makefile, main.c
- In Makefile, add '-D__USE_SAMX21__' in line CFLAGS_EXTRA?=

Below is the original file description:
